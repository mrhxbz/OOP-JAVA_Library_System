...
public class AddPatronWindow extends JFrame implements ActionListener{
	...
	private JTextField pNumberText = new JTextField();
	private JTextField emailText = new JTextField();
	private JTextField visText = new JTextField();
    ...
    private void initialize() {
         ...
         topPanel.add(pNumberText);
         
         topPanel.add(new JLabel("Email : "));
         topPanel.add(emailText);
         
         topPanel.add(new JLabel("Status : "));
         topPanel.add(visText);
	...
	private void addPatron() {
		try {
			...
			String phone = pNumberText.getText();
